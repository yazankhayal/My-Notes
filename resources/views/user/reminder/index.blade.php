...
@section('link') {{route('reminder.create')}} @endsection
@section('name-link') <i class="fa fa-check-circle"></i> Create new Reminder @endsection
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn_delete_current', function () {
                var id = $(this).data("id");
                var url = "{{ route('reminder.deleted') }}";
