        ...
        <div class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card">
                <form class="ajaxForm insert" enctype="multipart/form-data" data-name="insert"
                    ...
                    {{csrf_field()}}
                    <input id="id" name="id" type="hidden" value="{{$pages->id}}">
                    <div class="card-header">All fields are required for the To Do Lists to be created for you.</div>
                    <div class="card-body">
                        <div class="row">

                            @include("inputs.input",['id' => 'name','name' => 'Name','col' => 'col-xs-12 col-md-12 col-lg-6 col-xl-6','value' => $pages->name])
                            @include("inputs.file",['id' => 'avatar','name' => 'avatar','col' => 'col-xs-12 col-md-12 col-lg-6 col-xl-6','value' => $pages->avatar])
                            @include("inputs.textarea",['id' => 'body','name' => 'Body','col' => 'col-xs-12 col-md-12 col-lg-12 col-xl-12','value' => $pages->body])
